...
$(document).ready(function() {
	...
	$(window).scroll(function() {    
	    ...
	    /*if (scroll >= 95) {
			$(".navbar.navbar-default.ythdr").removeClass("affix-top");
			$(".navbar.navbar-default.ythdr").removeClass("fixit");
			$(".navbar.navbar-default.ythdr").addClass("affix");
			$(".navbar.navbar-default.ythdr").addClass("noaffix");
		}
		else{
			$(".navbar.navbar-default.ythdr").removeClass("affix-top");
			$(".navbar.navbar-default.ythdr").removeClass("affix");
			$(".navbar.navbar-default.ythdr").addClass("fixit");
			$(".navbar.navbar-default.ythdr").addClass("noaffix");
		}*/
