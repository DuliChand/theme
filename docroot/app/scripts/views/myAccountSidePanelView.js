...
(function() {
    'use strict';
    Webshop.Views.MyAccountSideViewBak = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            //this.myAccountSidePanel = new Webshop.Models.MyAccountSidePanel();
        ...
        render: function(data , subscriptionData) {
            ...
            self.notifyMePop(subscriptionData);
            customerObj = str;
            $('.errormsg1').hide();        
        ...
        notifyMePop: function(subscriptionData) {

                        var self = this;

                        $("#notifyMeBox").html(self.templates.notifications(subscriptionData));
                        console.log("json data ------"+JSON.stringify(customerObj));
                        if(customerObj.customers.customerSubscription){
