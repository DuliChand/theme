...
(function() {
    ...
    Webshop.Views.Pixlet = Backbone.View.extend({
	  ...
	  /*	if(($.cookie('ngAppTmpl')) || ngtmpldata === 'beta')
	  	{*/
		  	/*<iframe src="//www.googletagmanager.com/ns.html?id=GTM-N7VGLW" height="0" width="0" style="display:none;visibility:hidden"></iframe>*/
	  ...
	  vcommission: function(orderId , orderAmount){
        ...
        if(!(cookieData === "" || cookieData === undefined || cookieData === null)){
          ...
          if(map.utm_source.match(/vcommission/gi)){
			/*<iframe src="https://tracking.vcommission.com/SL4KU?adv_sub=TransactionID&amount=SaleAmount&adv_sub2=ModeOfPayment&adv_sub3=coupon/noncoupon&adv_sub4=couponname&adv_sub5=Category" scrolling="no" frameborder="0" width="1" height="1"></iframe>*/
            var scr = document.createElement("iframe");
  ...
  */
         ...
         /* if(map.utm_source.match(/iref/gi)){*/
	  ...
	  globalPixel: function (pixelData) {
		...
		/*if((pageURL.match(/confirmation$/) == null)) {
			var scr = document.createElement("script");
			var host = 'http://www.advantedges.com/advantages_pixel/fashion/Fashionandyou_remarketing.js';
			scr.setAttribute('src', host);
			(document.getElementsByTagName('script')[0].parentNode).appendChild(scr);
		}*/
        ...
        if(!(cookieData === "" || cookieData === undefined || cookieData === null)){
          ...
          if(map.utm_source.match(/icube/gi)){
			...
			(document.getElementsByTagName('script')[0].parentNode).appendChild(scr);
             ...
             //<iframe src="https://icubes.go2cloud.org/SL2tT?adv_sub=SUB_ID&adv_sub1=SUB_ID1&amount=AMOUNT" scrolling="no" frameborder="0" width="1" height="1"></iframe>
          }
        ...
        if(!(cookieData === "" || cookieData === undefined || cookieData === null)){
          ...
          if(map.utm_source.match(/digit/gi)){
			...
			(document.getElementsByTagName('script')[0].parentNode).appendChild(scr);
             ...
             //<iframe width="1px" height="1px" frameborder="0"  src="http://www.digit.in/microsites/pixelcode.html"></iframe> 
          }
      ...
      var cookieData = $.cookie('UTM_DATA');
        if(!(cookieData === "" || cookieData === undefined || cookieData === null)){
          ...
          if(map.utm_source.match(/payoom/gi)){
	        ...
	        //<iframe src="https://payoom.go2cloud.org/aff_l?offer_id=<%=request.getAttribute("orderId")%&adv_sub=ORDER_ID&amount=<%=request.getAttribute("orderAmount")%" scrolling="no" frameborder="0" width="1" height="1"></iframe>  
      ...
      var cookieData = $.cookie('UTM_DATA');
        if(!(cookieData === "" || cookieData === undefined || cookieData === null)){
          ...
          if(map.utm_source.match(/omg/gi)){
            ...
            // var omgCloud =  '<img src="https://track.in.omgpm.com/832173/transaction.asp?APPID='+orderId+'&MID=832173&PID=15764&status='+orderAmount+' border="0" height="1" width="1">';
            // $('head').append(omgCloud);
