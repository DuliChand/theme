...
(function () {
    ...
    Webshop.Models.ProfileAvailableBrandsView = Backbone.Model.extend({
    	el: '#brandForm',
        		events: {
                ...
                initialize: function () {
                    ...
                    this.addFavoriteBrands = new AddFavoriteBrands();
                    this.favoriteBrands = new FavoriteBrands();
                },
                render: function () {
                ...
                renderAvailableBrandsView : function () {
                	...
                	this.favoriteBrands.fetch({
        				...
        				success : function(model, response) {
        					...
        					if($(self.el).html(Handlebars.templates.brands(model.toJSON()))) {

        						$.fancybox($(self.el));
        						
        						console.log(Handlebars.templates.brands(model.toJSON()));
        						console.log($(self.el));
        					}
        				}
    				});
