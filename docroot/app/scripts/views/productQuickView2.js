define(
    [	'jquery','underscore','backbone','handlebars', 'handlebarshelpers', 'jquery.cookie',
	 	'/favourites-portlet/modules/models/product.js',
	 	'/favourites-portlet/modules/models/productFavouriteStatus.js',
	 	'/favourites-portlet/modules/models/liveInventory.js',
	 	'/favourites-portlet/modules/models/addProduct.js',
	 	'/favourites-portlet/modules/models/addProductToFavourites.js',
     	'/favourites-portlet/modules/models/removeProductFromFavourites.js',
     	'/favourites-portlet/modules/models/serviceability.js',
	    '/favourites-portlet/modules/templates/productdetail.js'
    ],
    function ($, _, Backbone, Handlebars, handlebarshelpers, jCookie, Product, ProductFavouriteStatus, LiveInventory, AddProduct, AddProductToFavourites, RemoveProductFromFavourites, Serviceability) {
        'use strict';
        var currSKUQnty,
        ...
        var ProductQuickView = Backbone.View.extend({
                ...
                addProductToCart : function(event){
                	...
                	var salePrice = $("#newPrice").text(),
                		...
                		selectedProductThumb = $("#product-gallery-thumbnails div a img").first().attr("src"),
