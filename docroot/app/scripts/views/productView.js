    ...
    Webshop.Views.ProductView = Backbone.View.extend({
        ...
        render: function(data) {
            var self = this;
                   ...
                   // console.log(JSON.stringify(value));
                        ...
                        if(value.selected == true)
                            ...
                            if(value.sellerSKUs.selected){  
                                ...
                                //selectedSKU = value.sellerSKUs.event.sellerId;
                             }
                ...
                $.each(data.product, function(index, cats){
                 ...
                 $(".select-choice .tiles").attr(data-attribute-value).addClass(selected);              
        ...
        updateProductGallery: function(data) {
            ...
            var prodGalleryThumbList = "";    
             ...
             console.log("data.product.images[thumbNode].originalUrl" + JSON.stringify(data.product.images[0].originalUrl));
