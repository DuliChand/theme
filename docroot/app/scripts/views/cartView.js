...
(function() {
    ...
    Webshop.Views.CartView = Backbone.View.extend({
        ...
        render: function(data) {
			console.log("cart data ----con"+data)
            var self = this;
            cartempData = data;
			...
			//console.log("cartdata---------->"+data);
                ...
                if((pageURL.match(/cart$/) != null)) {
                    ...
                    if (data.cart.products != "" || data.cart.products != undefined || data.cart.products != null) {
                        //console.log('inside if of cart 2');
                     if(data.cart.products.length){
                ...
                if((pageURL.match(/cart$/) != null)) {
                    ...
                    for (var i = 0; i < productSelectBoxList.length; i++) {
                        ...
                        var currQnty = parseInt(products[i].quantity),
                            ...
                            totalAvailableQnty;
                        //console.log("productSelectBoxList length: "+productSelectBoxList.length);
                        ...
                        //console.log("totalAvailableQnty: "+totalAvailableQnty +" currQnty: "+currQnty);
					...
					//	console.log('komli init---2 ');
						self.renderKomliPixel(komliPrdtId , komliPrdtName , komliCartVal);
					//	console.log('komli init---3 ');
						//--Komli pixel cart func ends here----
                 }
					
					
                    if ($("#orderSummary")) {
                   //     console.log("order summary render function");
        ...
        updateProductInCart: function(event) {
            ...
            var productData = {
				...
				"productRequestWrapper":
				{
					...
					"productName":$(currProduct).find('.cart-det-prodname').text(),
					"thumbUrl": $(currProduct).find('img').attr('src')
        ...
        updateSizeSelection : function(e){
			...
			updateData= {
							...
							"productRequestWrapper":
							{
								...
								"skuId": newSku,
								"eventId": $(currProduct).data('event-id'),
								"productName": $(currProduct).data('product-name'),
								"thumbUrl": $(currProduct).find('img').attr('src')
