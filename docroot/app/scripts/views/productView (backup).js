        ...
        render: function(data) {
            ...
            //console.log("time ver" + timeVer );
                     ...
                     //   console.log("availableSkuList: "+availableSkuList);
                        ...
                        $("#productDetail").html(self.templates.product(data));
                        ...
                        var endDate = new Date(data.vendorProductWrapper.vendorProduct.event.endDate),
                			currDate = new Date(),
						...
						startEventDate = data.vendorProductWrapper.vendorProduct.event.startDate;
						...
						var prdtId = data.vendorProductWrapper.vendorProduct.product.productId,
						prdtName = data.vendorProductWrapper.vendorProduct.product.name,
						salePrice = data.vendorProductWrapper.liveinventory.salePriceWithVAT,
						qtyAvailable = data.vendorProductWrapper.liveinventory.quantity ,
						catId = data.vendorProductWrapper.vendorProduct.category.categoryId,
						catName = data.vendorProductWrapper.vendorProduct.category.categoryName ;
            ...
            $(prodImageRepo).each(function(index, obj) {
                ...
                if (obj.skuId === selectedSKU) {
                    ...
                    $(obj.imageList).each(function(index, img) {
                        ...
                        prodGalleryThumbList += '<div class="slide"><a href="'+img.originalURL+'" class="thumbnail-image" rel="zoom-id:ex1" rev="'+img.detailsURL+'" data-image-detail=" ' ;
                    ...
                    $('#ex1').attr('href',obj.imageList[0].originalURL);
